 ...
 */
export function decodeAlgorandAddress(address) {
 ...
 */
export function encodeReceiptNoteField(digestHex) {
 ...
 */
export function decodeReceiptNoteField(noteBase64) {
    try {
...
export function buildAlgorandChallenge(params) {
    ...
    const genesisHash = params.network === 'algorand-mainnet'
        ? ALGORAND_MAINNET_GENESIS_HASH
        : ALGORAND_TESTNET_GENESIS_HASH;
    const assetId = params.requiredAsset === 'USDCa'
 ...
 */
export function verifyAlgorandReceiptAgainstChallenge(challenge, receipt, currentRound) {
 ...
 */
export function verifyAlgorandStateProofCommitment(commitment, expectedRootHash) {
...
export class AlgorandSettlementAdapter {
    network;
    recipientAddress;
    constructor(recipientAddress, network = 'algorand-mainnet') {
     ...
     */
    verifySettlement(challenge, receipt, currentRound) {
...
//# sourceMappingURL=settlement-adapter.js.map